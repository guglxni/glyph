...
fn is_x86_architecture() -> bool {
    // Patched: allow Docker prover to run on any host architecture.
    // Docker itself provides the x86_64 prover container via amd64 emulation.
    let _ = ARCH; // suppress unused-import warning
    true
}
